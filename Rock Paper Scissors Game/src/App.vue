	...
	<div
		...
		<Header
			...
			<img
				...
				class="h-[48px] w-[83px]" />
			<div
				class="whiteGradient flex h-fit w-20 flex-col items-center gap-0 rounded-[4px] py-[10px] pl-6 pr-[23px]">
				<span
					class="text-center text-[10px] font-semibold uppercase leading-3 tracking-[1.563px] text-fem-score"
					>score</span
				>
				<span
